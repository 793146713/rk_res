 ...
 */
import cn.zhy.resouese.exception.FileNameLengthLimitExceededException;
import cn.zhy.resouese.exception.InvalidExtensionException;
...
public class FileUploadUtils {
  ...
  public static final String upload(
      HttpServletRequest request, MultipartFile file, BindingResult result) {
  ...
  public static final String extractFilename(
      MultipartFile file, String baseDir, boolean needDatePathAndRandomName)
    ...
    if (needDatePathAndRandomName) {
      filename =
          baseDir + File.separator + datePath() + File.separator + encodingFilename(filename);
    } else {
  ...
  private static final String encodingFilename(String filename) {
    ...
    filename = encryptMD5(filename + System.nanoTime() + counter++) + "_" + filename;
    return filename;
  }
   ...
   * @throws FileSizeLimitExceededException 如果超出最大大小
   */
  public static final void assertAllowed(
