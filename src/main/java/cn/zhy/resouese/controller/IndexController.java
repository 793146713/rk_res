...
public class IndexController {
  ...
  public Object getAllbiaoqian(@PathVariable(value = "id", required = true) Integer id) {
    return resouceLableService.selectList(new EntityWrapper<ResouceLable>().eq("site_type", id));
  }
  ...
  public Object paihang(@PathVariable(value = "id", required = true) Integer id) {
    ...
    return resouceContentService.selectPage(new Page<ResouceContent>(0, 5), wrapper).getRecords();
  }
  ...
  public Object getResousByBiaoqian(@PathVariable(name = "id", required = true) Integer id) {
    ...
    if (list.size() >= 1) {
      List<ResouceContent> contentList =
          resouceContentService.selectList(new EntityWrapper<ResouceContent>().in("id", list));
